...
const members = {
    ...
    serviceBill     :20,
    othersBill      :220,
    runningMonth    :"July-24",
    previousMonth   :"June-24", // new addDecember
    upComingMonth   :"August 1,2024",
    runningMealRate :56,
    ...
    "01814843266":{
        ...
        payment             :{"08/07/24-Cash":4500},
        // running month {"01/07/24-Cash":500}
        stay_cost       :2200,
        garage_cost     :0,
        running_payable :2854,
        running_paid    :4500,
        running_meal    :35,
        // method calling
        preMonth,
    ...
    "01922362569":{
        ...
        previous_paid       :4500,
        previous_dining_cost:1250,
        payment             :{"11/07/24-DBBL":2100,"11/07/24-Cash":1100,"30/07/24-Light":100},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :2050,
        running_paid    :3300,
        running_meal    :26,
        // method calling
        preMonth,
    ...
    "01780608997":{
        ...
        previous_paid       :4200,
        previous_dining_cost:1250,
        payment             :{"16/07/24-NAGAT":6500,"30/07/24-Mills":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :5550,
        running_paid    :7000,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01640454889":{
        ...
        payment             :{"06/07/24-Cash":2000,"13/07/24-Cash":3000},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :3214,
        running_paid    :5000,
        running_meal    :27,
        // method calling
        preMonth,
    ...
    "01645122114":{
        ...
        previous_paid       :3500,
        previous_dining_cost:1250,
        payment             :{"09/07/24-Cash":4000,"13/07/24-Cash":1000,"22/07/24-Cash":1000,"30/07/24-Mills":220},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :5123,
        running_paid    :6220,
        running_meal    :47,
        // method calling
        preMonth,
    ...
    "01714443406":{
        ...
        payment             :{"01/07/24-Cash":1000,"06/07/24-Cash":3000,"12/07/24-Bkash":2000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :3454,
        running_paid    :6000,
        running_meal    :28,
        // method calling
        preMonth,
    ...
    "01834648400":{
        ...
        previous_paid       :3000,
        previous_dining_cost:1250,
        payment             :{"01/07/24-Bkash":4000},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :2501,
        running_paid    :4000,
        running_meal    :25,
        // method calling
        preMonth,
